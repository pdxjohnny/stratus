...
def main():
	...
	http = stratus.server( ( address, 80 ), example(), bind_and_activate = False, threading = True )
	https = stratus.server( ( address, 443 ), example(), bind_and_activate = False, threading = True, key = 'server.key', crt = 'server.crt' )
